...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 04 août 2026 à 20:40
...
(15, 'FASTEF', 'Faculté des Sciences et Technologies de l’Éducation et de la Formation', 'publique', 'Sénégal', 'Dakar', 'Dakar', 'https://fastef.ucad.sn', '/assets/logo/universites/FASTEF.png'),
...
(10, 10, 'L’École Nationale de la Statistique et de l’Analyse Économique (ENSAE Sénégal) est une grande école publique spécialisée dans la formation des statisticiens, économistes et analystes de données. Elle joue un rôle majeur dans la formation des cadres destinés aux administrations publiques, aux organisations internationales, aux entreprises et aux institutions de recherche. L’école forme des spécialistes capables d’exploiter les données pour l’aide à la décision, la planification économique et l’évaluation des politiques publiques.', 'L’admission se fait principalement par concours selon le niveau d’études du candidat. Les conditions varient selon le cycle de formation proposé.', 'Les étudiants peuvent bénéficier de bourses et d’appuis financiers selon les programmes disponibles et les dispositifs publics.'),
(11, 11, 'L’École Nationale Supérieure d’Agriculture (ENSA) est un établissement public sénégalais spécialisé dans la formation des ingénieurs agronomes et des cadres du secteur agricole. Elle contribue au développement de l’agriculture sénégalaise à travers la formation, la recherche et l’innovation. L’école forme des professionnels capables d’intervenir dans la production agricole, la gestion des ressources naturelles, l’agroalimentaire et le développement rural.', 'L’admission se fait généralement par concours ou selon les conditions académiques définies par l’établissement.', 'Les étudiants peuvent bénéficier de bourses nationales ou d’aides liées aux formations agricoles.'),
(12, 12, 'L’École Polytechnique de Thiès (EPT) est une grande école publique sénégalaise spécialisée dans la formation d’ingénieurs et de cadres scientifiques. Elle participe au développement des compétences techniques du Sénégal dans les domaines de l’ingénierie, des infrastructures, de l’industrie, de l’énergie et des technologies. L’école accueille des étudiants sélectionnés selon des critères académiques exigeants et contribue également aux activités de recherche et d’innovation.', 'L’admission se fait principalement par concours ou selon les conditions spécifiques des cycles de formation proposés.', 'Les étudiants peuvent bénéficier des bourses nationales et des dispositifs d’aide destinés aux étudiants des établissements publics.'),
(13, 13, 'L’École Inter-États des Sciences et Médecine Vétérinaires (EISMV) est un établissement sous-régional spécialisé dans la formation des vétérinaires et des cadres des sciences animales. Elle accueille des étudiants provenant de plusieurs pays africains et joue un rôle important dans la santé animale, la sécurité alimentaire et le développement de l’élevage en Afrique de l’Ouest.', 'L’admission se fait selon les modalités définies par l’école, généralement à travers une sélection ou un concours.', 'Les étudiants peuvent bénéficier de bourses nationales, internationales ou de programmes de coopération.'),
(14, 14, 'L’École Normale Supérieure d’Enseignement Technique et Professionnel (ENSETP) est un établissement public spécialisé dans la formation des enseignants techniques et professionnels. Elle contribue au développement de l’enseignement professionnel au Sénégal en préparant des formateurs capables de transmettre des compétences techniques dans différents secteurs.', 'L’admission dépend des concours et critères pédagogiques définis par l’établissement.', 'Les étudiants peuvent bénéficier d’aides et de bourses selon les dispositifs publics disponibles.'),
(15, 15, 'La Faculté des Sciences et Technologies de l’Éducation et de la Formation (FASTEF) est un établissement de formation des enseignants rattaché à l’Université Cheikh Anta Diop de Dakar (UCAD). Elle joue un rôle essentiel dans la préparation et le perfectionnement des enseignants du système éducatif sénégalais. Ses formations concernent notamment la pédagogie, la didactique et les sciences de l’éducation.', 'L’admission dépend des niveaux universitaires requis et des concours ou sélections organisés par l’établissement.', 'Les étudiants peuvent bénéficier des dispositifs publics de soutien et des bourses universitaires.'),
(16, 16, 'L’Institut National Supérieur de l’Éducation Populaire et du Sport (INSEPS) est un établissement public rattaché à l’Université Cheikh Anta Diop de Dakar (UCAD). Il est spécialisé dans la formation des professionnels du sport, de l’éducation physique et de l’animation sportive. L’institut contribue au développement des compétences dans le domaine sportif au Sénégal.', 'L’admission se fait selon les critères académiques et sportifs définis par l’établissement.', 'Les étudiants peuvent bénéficier des bourses nationales et aides sociales universitaires.'),
(17, 17, 'L’École des Bibliothécaires, Archivistes et Documentalistes (EBAD) est un établissement public rattaché à l’Université Cheikh Anta Diop de Dakar (UCAD). Elle est spécialisée dans la formation des professionnels de l’information documentaire, notamment dans les domaines des bibliothèques, archives, documentation et gestion de l’information.', 'L’admission dépend des niveaux d’études requis et des conditions fixées pour chaque formation.', 'Les étudiants peuvent bénéficier des aides et bourses universitaires selon les dispositifs disponibles.'),
(18, 18, 'Le Centre Africain d’Études Supérieures en Gestion (CESAG) est un établissement d’enseignement supérieur spécialisé dans la gestion, la finance, le management et les domaines associés. Il possède un statut particulier avec une vocation régionale africaine et accueille des étudiants et professionnels provenant de plusieurs pays. Le CESAG joue un rôle important dans la formation des cadres et dirigeants dans les secteurs publics et privés.', 'L’admission dépend des programmes proposés et des niveaux académiques ou professionnels demandés.', 'Les étudiants peuvent bénéficier de bourses, de programmes de coopération et de dispositifs d’accompagnement selon les formations.');
...
--
ALTER TABLE `filiere`
  MODIFY `id_filiere` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=179;
...
--
ALTER TABLE `universite`
  MODIFY `id_universite` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
