        ...
        fetch(
            ...
            .then((data) => {
                ...
                if (data.success) {
                    ...
                    setErreur(
                        data.message ||
                        "Impossible de r̩cup̩rer l'historique."
                    );
        ...
        return (
            ...
            <div className="historique-tests-page">
                ...
                <div className="historique-tests-loading">
                    ...
                    <p>
                        Nous r̩cup̩rons vos tests d'orientation.
                    </p>
            ...
            <header className="historique-tests-header">
                    ...
                    <div className="historique-tests-title">
                        ...
                        <div>
                            ...
                            <p className="historique-tests-description">
                                ...
                                avez effectu̩s et consultez vos r̩sultats.
                            </p>
                ...
                <div className="historique-tests-summary">
                    ...
                    <div>
                        ...
                        <span>
                            test{tests.length > 1 ? "s" : ""} effectu̩
                            {tests.length > 1 ? "s" : ""}
                        </span>
            ...
            <main className="historique-tests-content">
                ...
                {tests.length === 0 ? (
                    ...
                    <section className="historique-tests-empty">
                        ...
                        <p>
                            Vous n'avez pas encore effectu̩ de test
                            d'orientation. Commencez votre parcours pour
                            d̩couvrir votre profil professionnel.
                        </p>
                    ...
                    <>
                        ...
                        <section className="historique-tests-introduction">
                            ...
                            <div>
                                ...
                                <h2>
                                    Vos tests pr̩c̩dents
                                </h2>

                                <p>
                                    Consultez vos diff̩rents r̩sultats
                                    pour suivre l'̩volution de votre
                                    orientation.
                                </p>
