...
function MetierDetail() {
    ...
    useEffect(() => {
        ...
        .catch((error) => {
            ...
            console.error(
                "Erreur r̩cup̩ration d̩tail m̩tier :",
                error
            );
    ...
    return(
        ...
        <div className="metier-introuvable">
            ...
            <h2><FaCircleInfo /> M̩tier introuvable</h2>

            <p>

                Le m̩tier demand̩ n'existe pas ou n'est plus disponible.
            ...
            >
                ...
                <FaArrowLeft /> Retour aux m̩tiers
    ...
    return (
        ...
        {metier.secteur}
            ...
            <section className="detail-section">
                ...
                <h2>
                    <FaBookOpen /> Pr̩sentation du m̩tier</h2>
            ...
            <section className="detail-section">
                ...
                <h2><FaBriefcase /> Comp̩tences n̩cessaires</h2>
    ...
    <strong>
        {metier.salaire_max} FCFA
            ...
            <section className="detail-section">
                ...
                <h2><FaGraduationCap /> Fili̬res li̩es</h2>
