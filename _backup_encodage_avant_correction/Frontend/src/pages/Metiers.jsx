        ...
        <div className="metiers-page">
            ...
            <div className="metiers-header">
                ...
                <h1>
                    ...
                    /> Catalogue des m̩tiers
                </h1>


                <p>
                    D̩couvrez les m̩tiers, leurs secteurs,
                    niveaux d'̩tudes, salaires et tendances.
                </p>
    ...
    <div className="filtre-item">
        ...
        >
           ...
           <div className="metiers-count">
             ...
             {resultats.length} m̩tier{resultats.length > 1 ? "s" : ""} trouv̩{resultats.length > 1 ? "s" : ""}
        ...
        chargement ? (
            ...
            resultats.map((metier) => (
                ...
                >
                    ...
                    <p>
                        <strong>
                            <FaGraduationCap/> Niveau d'̩tude :
                        </strong>{" "}
                        {metier.niveau_etude}
                    </p>
            ...
            <div className="aucun-metier">
                ...
                <h2>
                    <FaFaceFrown/> Aucun m̩tier trouv̩
                </h2>

                <p>
                    Essayez un autre mot-cl̩,
                    un autre secteur
                    ou un autre niveau d'̩tude.
                </p>
