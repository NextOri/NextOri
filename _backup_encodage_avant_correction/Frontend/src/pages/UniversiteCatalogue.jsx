...
export default function UniversiteCatalogue() {
  ...
  useEffect(() => {
    ...
    fetch(API_URL)
      ...
      .catch((error) =>
        console.error(
          "Erreur rÃ©cupÃ©ration universitÃ©s :",
          error
        )
      )
...
useEffect(() => {
  ...
  return (
    ...
    <div className="no-universite-catalogue-page">
      ...
      <div className="no-universite-catalogue-header">
        ...
        <h1>
          Explorer les universitÃ©s
        </h1>


        <p>
          Trouvez l'Ã©tablissement qui correspond
          Ã  votre projet acadÃ©mique.
        </p>
      ...
      <div className="no-universite-catalogue-toolbar">
        ...
        <div className="search-container">
          ...
          <input
            type="text"
            placeholder="Rechercher une universitÃ©..."
            value={search}
            onChange={(e) =>
  ...
  {universitesFiltrees.length > 0 ? (
    ...
    <div className="no-universite-catalogue-empty">
      ...
      <h2>
        Aucune universitÃ© trouvÃ©e
      </h2>

      <p>
        Essayez un autre nom, un autre type
        ou une autre rÃ©gion.
      </p>
