    ...
    if (chargement) {
        ...
        return (
            ...
            <div className="no-universite-detail-loading">
                ...
                <p>Chargement de l'universit̩...</p>
    ...
    if (!universite) {
        ...
        return (
            ...
            <div className="no-universite-detail-not-found">
                ...
                <h2>Universit̩ introuvable</h2>

                <p>
                    Cette universit̩ n'existe pas ou n'est plus disponible.
                </p>
                ...
                >
                    ...
                    <span>Retour aux universit̩s</span>
            ...
            <main className="no-universite-detail-content">
                ...
                <section className="no-universite-detail-presentation">
                    ...
                    <div className="no-universite-detail-text">
                        ...
                        <p>
                            {detail?.presentation ||
                                "Aucune pr̩sentation disponible pour cette universit̩."}
                        </p>
            ...
            >
                ...
                <section className="no-universite-detail-admission">
                    ...
                    <div className="no-universite-detail-section-title">
                        ...
                        <div>
                            <span>Int̩grer l'̩tablissement</span>
                ...
                <section className="no-universite-detail-filieres">
                    ...
                    <div className="no-universite-detail-section-title">
                        ...
                        <div>
                            <span>Parcours acad̩miques</span>
                            <h2>Fili̬res propos̩es</h2>
                        </div>
...

                    {
                        filieres.length > 0 ? (
                            ...
                            <div className="no-universite-detail-empty">
                                ...
                                <p>
                                    Aucune fili̬re n'est actuellement renseign̩e
                                    pour cette universit̩.
                                </p>
